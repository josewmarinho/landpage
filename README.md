...
| O quê | Arquivo |
|---|---|
| **Links** (vakinha, WhatsApp, redes sociais, linktree, política de privacidade) | `src/data/links.ts` |
...
> (`wa.me/5517000000000`, `vakinha.com.br`, etc). Substitua pelos oficiais antes de publicar.
